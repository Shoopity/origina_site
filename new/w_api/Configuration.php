...
class Configuration
{
	const RESELLER_REQUEST_SECRET = 'e9d6f5f7b7dc48d031b07645b4bb2386b83edbd0cc284e8d55bf8af446853384';
	const ERROR_REPORTING_LEVEL = '0';
	const DEPLOYED_HOSTNAME = 'creedeanimalclinic.com';
	const CLOUD_HOSTNAME = 'pages.weeblycloud.com';
	const DEPLOYED_HOSTNAME_HEADER = 'X-W-Cloud-Host';
	const BUILDDATE = '1734457526';
